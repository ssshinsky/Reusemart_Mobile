...
class ApiClient {
  ...
  //hunter
  Future<PegawaiProfile> getHunterProfileAndTotalCommission(int hunterId) async {
    final url = Uri.parse('$baseUrl/hunter/$hunterId/profile-and-commission');
    final response = await http.get(url, headers: _publicHeaders);
  ...
  Future<List<KomisiHistory>> getCommissionHistory(int hunterId) async {
    final url = Uri.parse('$baseUrl/hunter/$hunterId/commission-history');
    final response = await http.get(url, headers: _publicHeaders);
  ...
  Future<KomisiHistory> getCommissionDetail(int hunterId, int commissionId) async {
    final url = Uri.parse('$baseUrl/hunter/commission-detail/$hunterId/$commissionId'); 
    final response = await http.get(url, headers: _publicHeaders);
